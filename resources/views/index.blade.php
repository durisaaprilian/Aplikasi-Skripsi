...
<section class="price_section layout_padding">
        ...
        <div class="price_container">
            <div class="item_container">
                <div class="row row-cols-4 row-cols-md-4 g-4">
                    @foreach($data['kepribadian'] as $kepribadian)
                    <div class="col">
                        <div class="card text-center"><br>
                            <img src="{{asset('images/'.$kepribadian->gambar)}}" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title"><b>{{$kepribadian->type}}</b></h5>
                                <p class="card-text">{{$kepribadian->kepribadian}}</p>
                            </div>
                        </div>
                    </div>
                    @endforeach
    ...
    <div class="d-flex justify-content-center">
        <a href="{{url('tipekepribadian')}}" class="price_btn">See More</a>
    </div>
</section>
<!-- end price section -->
@endsection